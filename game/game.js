...
// removed on request, and the tethers that this note used to point at as the
// surviving signal have since gone the same way. What an object is under the
// control of now reads from the carry wheel overhead and the CARRY readout.
//
